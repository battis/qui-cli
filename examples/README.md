...
<dl>
<dt><a href="dev-command/README.md">@examples/dev-command</a></dt><dd>A distributable command-line app</dd>
<dt><a href="dev-default-hooks/README.md">@examples/dev-default-hooks</a></dt><dd>Use the default hooks provided by @qui-cli/plugin</dd>
